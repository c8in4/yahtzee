...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://yahtzee/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://yahtzee/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://yahtzee/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://yahtzee/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _diceClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./diceClass */ \"./src/diceClass.js\");\n/* harmony import */ var _renderDice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderDice */ \"./src/renderDice.js\");\n\n\n\n\nconst yahtzeeDice = []\nconst rolledDice = []\nconst keeperDice = []\n\nfor (let i = 0; i < 5; i++) {\n  const dice = new _diceClass__WEBPACK_IMPORTED_MODULE_1__.Dice(6)\n  yahtzeeDice.push(dice)\n}\n\n// yahtzeeDice.forEach(dice => {\n//   rolledDice.push(dice.rollDice())\n// })\n\n// console.log(rolledDice)\n\n(0,_renderDice__WEBPACK_IMPORTED_MODULE_2__.RenderDice)(yahtzeeDice)\n\n// Dice test ###############################\n// console.log('-- START OF DICE TEST --')\n// import { Dice } from \"./diceClass\";\n\n// const dice = new Dice(6)\n\n// console.log('first roll: ' + dice.rollDice())\n// dice.switchKeepDice()\n// console.log('second roll: ' + dice.rollDice())\n// dice.switchKeepDice()\n// console.log('third roll: ' + dice.rollDice())\n// #########################################\n\n\n//# sourceURL=webpack://yahtzee/./src/index.js?");
